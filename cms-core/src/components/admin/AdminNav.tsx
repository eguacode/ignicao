...
import {
    ...
    Sparkles, Package, LayoutTemplate, Award
} from 'lucide-react';
...
const pageItems: NavItem[] = [
    { label: 'Hero', href: '/admin/hero', icon: LayoutTemplate, section: 'hero' },
    { label: 'Banners da Equipe', href: '/admin/banners', icon: Award, section: 'banners' },
    ...
    { label: 'Barra Lateral', href: '/admin/sidebar', icon: LayoutTemplate, section: 'sidebar' },
